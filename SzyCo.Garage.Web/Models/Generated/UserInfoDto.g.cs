...
{
    public partial class UserInfoParameter : GeneratedParameterDto<SzyCo.Garage.Data.Auth.UserInfo>
    {
        ...
        /// </summary>
        public override void MapTo(SzyCo.Garage.Data.Auth.UserInfo entity, IMappingContext context)
        {
        ...
        /// </summary>
        public override SzyCo.Garage.Data.Auth.UserInfo MapToNew(IMappingContext context)
        {
            var includes = context.Includes;

            var entity = new SzyCo.Garage.Data.Auth.UserInfo()
            {
                Roles = Roles,
    ...
    public partial class UserInfoResponse : GeneratedResponseDto<SzyCo.Garage.Data.Auth.UserInfo>
    {
        ...
        /// </summary>
        public override void MapFrom(SzyCo.Garage.Data.Auth.UserInfo obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
            var includes = context.Includes;
